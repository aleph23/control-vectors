...
def __main__(
    ...
    parser.parse_args(cli_arguments())
    ...
    if conceptors:
        print(f"==> Running ConceptorAnalyzer with aperture={conceptor_aperture} center={center}")
        ...
        model_handler = ModelHandler(model, device="cuda", precision=precision)
